...
export default function ContactPage() {
  ...
  const inputClass =
    "w-full px-4 py-3 rounded-lg border border-[var(--border)] bg-[var(--card)] text-[var(--fg)] placeholder:text-[var(--fg-muted)] focus:border-accent transition-colors text-sm";
